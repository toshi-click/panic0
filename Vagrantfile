...
Vagrant.configure("2") do |config|
  ...
  config.vm.network "private_network", ip: "192.168.254.103"
  ...
  if Vagrant::Util::Platform.wsl?
    config.vm.synced_folder ".", "/app/panic0", owner: 'vagrant', group: 'vagrant', mount_options: ['dmode=776', 'fmode=775']
  else
    ...
    config.bindfs.bind_folder "/nfs/mount", "/app/panic0",
                              :owner => "toshi",
                              :group => "toshi",
                              :'create-as-user' => true,
                              :perms => "u=rw:g=rw:o=r",
